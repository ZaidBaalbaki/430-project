...
def editPatient(request,id):
    ...
    if request.method == 'POST':
        ...
        obj=Patient_Profile.objects.filter(pt_id=id)
        if not obj:
            pt_obj=Patient_Profile.objects.create(pt_id=id,name=name,gender=gender,country=country,age=age,phone=phone,city=city,address=address,upload=upload)
